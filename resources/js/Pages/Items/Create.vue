                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <section class="text-gray-600 body-font relative">
                        ...
                        <div class="container px-5 py-8 mx-auto">
                            <div class="flex pl-4 my-4 w-24  ml-64">
                                    <Link as="button" :href="route('items.index')" class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">戻る</Link>
                                </div>
